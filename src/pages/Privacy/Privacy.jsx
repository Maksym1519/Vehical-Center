  ...
  setClicked(index);
    ...
    <div className={p.privacy__wrapper}>
      ...
      <AccordionSection>
            ...
            return (
              ...
              <div className={p.line__wrapper}>
                <Wrap onClick={() => toggle(index)} key={index}>
                  ...
                  <span className={p.arrow__wrapper}>{clicked === index ? <img src={ArrowTop} alt="arrow" /> : <img src={ArrowDown} alt="arrow" className={p.terms__arrow} />}</span>    
                </Wrap>
                {clicked === index ? (
                <Dropdown><p className={p.dropdown__text}>{item.content}</p></Dropdown>
                ) : null}
                </div>
              </>
            );
       ...
       <div className={p.footer__wrapper}><Footer /></div>
    </div>
    )
}
