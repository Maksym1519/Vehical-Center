    ...
    <div className={m.wrapper}>
      ...
      <div className={m.itWork}>
        <div className={m.cars__wrapper}>
          <div className={m.itWork__carLeft}>
            <img src={Honda} alt="car" />
          </div>
          <div className={m.itWork__carRight}>
            <img src={Lexus} alt="car" />
          </div>
        </div>
      ...
      <div className={m.steps}>
        <div className={m.steps__items}>
          ...
          <div className={m.step__item}>
            ...
            <div className={m.step__item__infoWrapper}>
              ...
              <p className={m.step__item__text}>
          ...
          <div className={m.step__item}>
            ...
            <div className={m.step__item__infoWrapper}>
              ...
              <p className={m.step__item__text}>
                One of our Qualified Agents sends you custom pictures and videos
                of the car you are interested in.
              </p>
            </div>
          </div>
          <div className={m.step__item}>
            ...
            <div className={m.step__item__infoWrapper}>
              ...
              <p className={m.step__item__text}>
                You work with a dedicated Qualified Agent to secure financing on
                your terms.
              </p>
            </div>
          </div>
          <div className={m.step__item}>
            ...
            <div className={m.step__item__infoWrapper}>
              ...
              <p className={m.step__item__text}>
                We deliver your car to your home or office for you to test
                drive.
              </p>
            </div>
          </div>
          <div className={m.step__item}>
            ...
            <div className={m.step__item__infoWrapper}>
              ...
              <p className={m.step__item__text}>
                If you love the vehicle, you sign the paperwork and keep the
                car.
              </p>
            </div>
          </div>
        ...
        <div className={m.steps__imagesWrapper}>
          <div>
            <img src={StepsImg1} alt="map" className={m.steps__img1} />
          </div>
          <div>
            <img src={StepsImg2} alt="map" className={m.steps__img2} />
          </div>
        </div>
      </div>
        ...
        <div className={m.advantages__container}>
          ...
          <div className={m.advantages__itemsWraper}>
            <div className={m.advantages__item}>
              ...
              <div
                className={
                  m.advantages__item__info + " " + m.advantages__item__info1
                }
              >
                <img src={AdvLogo1} alt="logo" />
                <h4 className={m.advantages__item__title}>Vehicle Delivery</h4>
                <p className={m.advantages__item__text}>
            ...
            <div className={m.advantages__item}>
              <div
                className={
                  m.advantages__item__imgWrapper +
                  " " +
                  m.advantages__item__imgWrapper2
                }
              >
              ...
              <div
                className={
                  m.advantages__item__info + " " + m.advantages__item__info2
                }
              >
                ...
                <p className={m.advantages__item__text}>
                  ...
                  strongest financing options in the industry—including rates as
                  low as 4%
                </p>
              </div>
            </div>
            <div className={m.advantages__item}>
              ...
              <div
                className={
                  m.advantages__item__info + " " + m.advantages__item__info3
                }
              >
                ...
                <p className={m.advantages__item__text}>
                  ...
                  them to you at wholesale prices. Your dream car is waiting for
                  you
                </p>
              </div>
            </div>
      ...
      <div className={m.chooseCar}>
        <div className={m.chooseCar__container}>
          ...
          <div className={m.chooseCar__info}>
            <h3 className={m.chooseCar__info__title}>
              Сhoose your dream vehicle in our catalog
            </h3>
            <p className={m.chooseCar__info__text}>
              In our catalogue there are many models of vehicles. Choose your
              car to your liking.
            </p>
            <Link to='/catalog' className={m.chooseCar__info__buttonWrapper}>
      ...
      <div className={m.statistics}>
        <div className={m.statistics__container}>
          <div className={m.statistics__description}>
            ...
            <p className={m.description__text}>
          ...
          <div className={m.statistics__itemsWrapper}>
            ...
            <div className={m.statistics__item}>
              ...
              <span className={m.statistics__item__text}>
          ...
          <div className={m.statistics__order}>
            <h3 className={m.statistics__order__title}>
